        ...
        <div class="master">
            <div class="box">
                ...
                <ul class="step">
                    ...
                    <li class="step__item {{ isActive('LaraInstaller::final') }}">
                        <i class="step__icon fa fa-server" aria-hidden="true"></i>
                    </li>
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('LaraInstaller::environment')}} {{ isActive('LaraInstaller::environmentWizard')}} {{ isActive('LaraInstaller::environmentClassic')}}">
                        @if(Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                            <a href="{{ route('LaraInstaller::environment') }}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('LaraInstaller::permissions') }}">
                        @if(Request::is('install/permissions') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                            <a href="{{ route('LaraInstaller::permissions') }}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('LaraInstaller::requirements') }}">
                        @if(Request::is('install') || Request::is('install/requirements') || Request::is('install/permissions') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                            <a href="{{ route('LaraInstaller::requirements') }}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('LaraInstaller::welcome') }}">
                        @if(Request::is('install') || Request::is('install/requirements') || Request::is('install/permissions') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                            <a href="{{ route('LaraInstaller::welcome') }}">
