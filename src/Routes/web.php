...
Route::group(['prefix' => 'install', 'as' => 'LaraInstaller::', 'namespace' => 'Sadashiv\LaraInstaller\Controllers', 'middleware' => ['web', 'install']], function () {
    Route::get('/', [
        'as' => 'welcome',
...
Route::group(['prefix' => 'update', 'as' => 'LaravelUpdater::', 'namespace' => 'Sadashiv\LaraInstaller\Controllers', 'middleware' => 'web'], function () {
